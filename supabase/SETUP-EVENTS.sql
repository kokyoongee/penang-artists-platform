...
-- SETUP EVENTS TABLE
-- ============================================
-- Run this in Supabase SQL Editor to add the events feature
-- This should be run AFTER the initial schema is set up

-- Check if event_type enum already exists
DO $$ BEGIN
...
DROP POLICY IF EXISTS "Anyone can view published events of approved artists" ON events;
