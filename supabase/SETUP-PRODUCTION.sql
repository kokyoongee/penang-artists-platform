-- ============================================
-- PENANG ARTISTS PLATFORM - PRODUCTION SETUP
-- ============================================
-- Run this ONCE in Supabase SQL Editor (supabase.com)
--
-- Steps:
...
-- Handle new user signup (creates profile automatically)
...
-- 3. Run seed.sql to add sample artists
-- ============================================
