...
import { getArtists } from '@/lib/sample-data';
...
export default function ArtistsDirectoryPage() {
  ...
  }, [searchQuery, selectedMedium, selectedLocation]);
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mb-8 flex items-center justify-between">
            <p className="text-[var(--color-charcoal)]/60">
              Showing <span className="font-medium text-[var(--color-charcoal)]">{artists.length}</span> artist{artists.length !== 1 ? 's' : ''}
            </p>
          </div>
